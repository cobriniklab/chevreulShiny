...
You can install the released version of chevreulShiny from <a href="https://github.com/whtns/chevreulShiny" target="_blank" rel="noopener noreferrer">github</a> with:
...
clustered_sce <- clustering_workflow(small_example_dataset,
